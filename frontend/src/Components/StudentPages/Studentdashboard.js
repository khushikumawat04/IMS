      ...
      <div class="tab-content" id="ex-with-icons-content">
              ...
              <div className="row">
                ...
                <div className="col-lg-6">
                  <div className="card mb-4">
                    ...
                    <h5>
                      Name : <span>{auth.user.username}</span>{" "}
                    </h5>{" "}
                    <br />
                    <h5>
                    ...
                    <br />
                    <h5>
                      UserType : <span>{auth.user.UserType}</span>{" "}
                    </h5>{" "}
                    <br />
                    <h5>
                    ...
                    <br />
                    <h5>
                      Course : <span>{auth.user.course} </span>{" "}
                    </h5>{" "}
                    <br />
                    <h5>
       ...
       <button onClick={handlePayment} type="button" class="btn btn-primary">Payment</button>*/}
        ...
        >
          ...
          {notice &&
            notice.map((item, index) => <p key={index}>{item.notice}</p>)}
        </div>
      </div>
    </div>
  );
