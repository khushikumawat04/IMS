...
import Atten from "./Components/StudentAttendance/Atten";
import Notice from "./Components/NoticeBoard/Notice";
import ClassWiseAttendance from "./Components/StudentAttendance/ClassWiseAttendance";
import AttendanceSheetForFullStack from "./Components/StudentAttendance/AttendanceSheetForFullStack";
import AttendanceSheet from "./Components/StudentAttendance/AttendanceSheet";
    ...
    <div className="App">
      <Router>
        ...
        <Routes>
          ...
          {/* <Route path='/viewattendance' element={<Atten/>}/> */}
          <Route path="/viewattendance" element={<ClassWiseAttendance />} />
          <Route
            path="/attendanceforfullstack"
            element={<AttendanceSheetForFullStack />}
          />
          <Route path="/attendancefordsa" element={<AttendanceSheet />} />
